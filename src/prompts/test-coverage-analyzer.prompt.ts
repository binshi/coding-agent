...
2. Search for corresponding test files using Grep and Glob tools (look for *.test.ts, *.spec.ts, __tests__/ directories).
3. Compare source code with test files to identify gaps.
